...
void setup()
{
    ...
    // Antena delay, adjust according to callibration. It will be different for every Anchor.
    sendData("AT+SETANT=16465", 2000, 1);
